...
CAMERA_SENSOR_WIDTH_DIRECTORY = "/home/titan/openmvs/openMVG/src/openMVG/exif/sensor_width_database"
    ...
    def __init__(self):
        self.steps_data=[
            ...
            [   "Compute features",
                ...
                ["-i", "%matches_dir%/sfm_data.json", "-o", "%matches_dir%", "-m", "AKAZE_FLOAT", "-n", "4"] ],
            [   "Compute matches",
...
parser.add_argument('-l','--last_step', type=int, default=7, help="the last step to process" )
